...
s&&r&&caches.delete(n)})})}function t(e,t){return!!t.find(function(t){return t.test(decodeURI(e))})}self.CACHE_BUSTER="1528382130741|0.980832034928141",self.addEventListener("install",function(e){return self.skipWaiting()}),self.addEventListener("activate",function(e){return self.clients.claim()})
var n=["assets/doughtime-402a1d47b678b1b1666c21479feeaa78.css","assets/doughtime-5d87168c1b47c7f9faf36d964913fd50.js","assets/vendor-3040c6541ce433d4b07e837a54da2e06.css","assets/vendor-26eb196bb822b002a7c0c94f4043fecf.js"],s="esw-asset-cache-1",r=n.map(function(e){return new URL(e,self.location).toString()}),i=function(){caches.open(s).then(function(e){return e.keys().then(function(t){t.forEach(function(t){-1===r.indexOf(t.url)&&e.delete(t)})})})}
...
var c=[],a=[]
self.INDEX_FILE_HASH="1fb2ee6b9769115d2d0f897cfd114b23"
